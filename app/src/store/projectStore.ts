...
const initialTasks: Task[] = [
  { id: '1', name: 'Estimate', subcontractor: 'Willett & Assoc.', duration: 10, lag: 0, es: 0, ef: 0, ls: 0, lf: 0, float: 0, isCritical: false },
  { id: '2', name: 'Clearing', subcontractor: 'Willett & Assoc.', duration: 3, lag: 0, es: 0, ef: 0, ls: 0, lf: 0, float: 0, isCritical: false },
  { id: '3', name: 'Site Prep', subcontractor: 'Willett & Assoc.', duration: 2, lag: 0, es: 0, ef: 0, ls: 0, lf: 0, float: 0, isCritical: false },
  { id: '4', name: 'Footer', subcontractor: '3C Concrete', duration: 4, lag: 0, es: 0, ef: 0, ls: 0, lf: 0, float: 0, isCritical: false },
  { id: '5', name: 'Block', subcontractor: 'Julio H', duration: 6, lag: 0, es: 0, ef: 0, ls: 0, lf: 0, float: 0, isCritical: false },
];
